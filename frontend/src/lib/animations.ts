// Framer Motion variants for landing page animations

import { Variants, Transition } from 'framer-motion';
import { animation } from './design-tokens';

// Spring configs
export const springTransition: Transition = { type: 'spring', stiffness: 260, damping: 20 };
...
// Search bar - changes glow color based on state (blue → yellow → green)
...
// Results list - staggered fade in from below
...
export const cardVariants: Variants = {
  idle: { y: 0, boxShadow: '0 0 0 1px rgba(255, 255, 255, 0.05)' },
  hover: {
    y: -2,
...
export const glassCardVariants: Variants = {
  idle: { backgroundColor: 'rgba(255, 255, 255, 0.03)', borderColor: 'rgba(255, 255, 255, 0.08)' },
  hover: {
...
export const primaryButtonVariants: Variants = {
  idle: { scale: 1, boxShadow: '0 0 0 0 rgba(75, 139, 190, 0)' },
  hover: { scale: 1.02, boxShadow: '0 0 25px rgba(75, 139, 190, 0.4)', transition: snappySpring },
  tap: { scale: 0.98 },
};

// Pills/tags (repo switcher)
export const pillVariants: Variants = {
  idle: { scale: 1, backgroundColor: 'rgba(39, 39, 42, 0.5)' },
  hover: { scale: 1.05, backgroundColor: 'rgba(39, 39, 42, 0.8)', transition: { duration: 0.15 } },
  selected: { scale: 1, backgroundColor: 'rgba(75, 139, 190, 0.2)', borderColor: '#4B8BBE' },
  tap: { scale: 0.95 },
};
...
export const fadeInVariants: Variants = {
  hidden: { opacity: 0 },
  visible: { opacity: 1, transition: { duration: animation.duration.normal / 1000 } },
};
...
export const blurInVariants: Variants = {
  ...
  visible: { opacity: 1, filter: 'blur(0px)', transition: { duration: animation.duration.slow / 1000 } },
};
...
export const highlightFlashVariants: Variants = {
  initial: { backgroundColor: 'rgba(255, 212, 59, 0.5)' },
  animate: { backgroundColor: 'rgba(255, 212, 59, 0.15)', transition: { duration: 0.8, delay: 0.3 } },
};

export const lineHighlightVariants: Variants = {
  idle: { backgroundColor: 'transparent' },
  hover: { backgroundColor: 'rgba(255, 255, 255, 0.03)', transition: { duration: 0.1 } },
};

// Expand/collapse (for AI explain panel)
